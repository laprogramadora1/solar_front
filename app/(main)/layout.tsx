                    ...
                    <div style={{ background: 'black' }} className="py-4 px-4 mx-0 md:mx-12 lg:mx-12 lg:px-8 flex align-items-center justify-content-between relative lg:static">
                        <Link href={URL + ''} className="flex align-items-center">
                            ...
                            <span className="text-900  font-medium text-2xl line-height-3 mr-8">
                                <b style={{ color: 'white' }}>AUTOCONSUMO FOTOVOLTAICO ECUADOR</b>
                            </span>
                        </Link>
                        ...
                        <div
                            ...
                            style={{ backgroundColor: 'black', top: '100%' }}
                        >
                            <ul style={{ background: 'black', width: '100%' }} className="list-none p-0 m-0 flex lg:align-items-center select-none flex-column lg:flex-row cursor-pointer">
                                <li>
                                    <Link href={URL + ''} className="p-ripple flex m-0 md:ml-5 px-0 py-3 text-900 font-medium line-height-3">
