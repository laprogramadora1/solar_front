...
const GuardarPerfil = () => {
    ...
    */
    ...
    const sendInfo = (datos) => {
        ...
        //console.log(datos);
        let data1 = { apellidos: datos.apellidos, nombres: datos.nombres, clave: datos.clave, external: external_cuenta };
                ...
                <div className="my-2">
                    <form onSubmit={handleSubmit(sendInfo)} className="p-fluid p-formgrid p-grid">
                        <div className="p-field p-grid" style={{ margin: '10px' }}>
                            ...
                            <div className="p-col">
                                <InputText id="firstname3" type="text" style={{ marginTop: '10px' }} placeholder="Ingrese su apellido" {...register('apellidos')} defaultValue={user && user.apellidos} />
                            </div>
                            {errors.apellidos && (
                        ...
                        <div className="p-field p-grid" style={{ margin: '10px' }}>
                            <label htmlFor="firstname" className="p-col-fixed">
                                <b>Nombres</b>
                            </label>
                            <div className="p-col">
                                <InputText id="firstname2" type="text" style={{ marginTop: '10px' }} placeholder="Ingrese su nombre" {...register('nombres')} defaultValue={user && user.nombres} />
                            </div>
                            {errors.nombres && (
                                <small style={{ marginTop: '10px' }} className="p-invalid text-xs inline-block py-1 px-2 rounded text-red-600">
                        ...
                        <div className="p-field p-grid" style={{ margin: '10px' }}>
                            ...
                            <div className="p-col">
                                <InputText id="firstname4" type="text" style={{ marginTop: '10px' }} placeholder="Ingrese su dni" defaultValue={user && user.dni} readOnly />
                            </div>
                        </div>
                        ...
                        <div className="p-field p-grid" style={{ margin: '10px' }}>
                            ...
                            <div className="p-col">
                                <InputText id="firstname5" type="text" style={{ marginTop: '10px' }} placeholder="Ingrese su correo" defaultValue={user && user.cuenta[0].correo} readOnly autoFocus />
                            </div>
                        </div>

                        <div className="p-field p-grid" style={{ margin: '10px' }}>
                            <label htmlFor="firstname6" className="p-col-fixed">
                                <b>Correo electronico</b>
                            </label>
                            <div className="p-col">
                                <Password
