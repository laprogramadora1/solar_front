    ...
    const searchBodyTemplate = (value) => {
        ...
        if(value.rol.nombre != 'ADMIN'){
            if(value.cuenta.estado == 'true' || value.cuenta.estado == true) {
                return <Button label='Desactivar' link icon='pi pi-user-minus' onClick={(e)=>{
                    const confirmBox = window.confirm(
                        "Desea realizar esta operación?"
                    );
                    if (confirmBox === true) {
                ...
                return <Button label='Activar' link icon='pi pi-user-plus' onClick={(e)=>{
                    const confirmBox = window.confirm(
                        "Desea realizar esta operación?"
                    );
                    if (confirmBox === true) {
        ...
        <div className="grid">
            ...
            <div className="col-12 xl:col-12">
                <div className="card">
                    ...
                    <div className="my-2">
                        <Button onClick={(e)=>{ruote.push(base_url+"dashboard/usuario/guardar")}}  label="Nuevo" outlined icon="pi pi-plus" severity="success" className=" mr-2" />
