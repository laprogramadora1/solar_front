                ...
                <div className="my-2">
                    <form onSubmit={handleSubmit(sendInfo)} className="p-fluid p-formgrid p-grid">
                        <div className="p-field p-grid" style={{ margin: '10px' }}>
                            ...
                            <div className="p-col">
                                <InputText id="firstname3" type="text" style={{ marginTop: '10px' }} placeholder="Ingrese su apellido" {...register('apellidos')} />
                            </div>
                            {errors.apellidos && (
                        ...
                        <div className="p-field p-grid" style={{ margin: '10px' }}>
                            ...
                            <div className="p-col">
                                <InputText id="firstname2" type="text" style={{ marginTop: '10px' }} placeholder="Ingrese su nombre" {...register('nombres')} />
                            </div>
                            {errors.nombres && (
                                <small style={{ marginTop: '10px' }} className="p-invalid text-xs inline-block py-1 px-2 rounded text-red-600">
                        ...
                        <div className="p-field p-grid" style={{ margin: '10px' }}>
                            ...
                            <div className="p-col">
                                <InputText id="firstname4" type="text" style={{ marginTop: '10px' }} placeholder="Ingrese su dni" {...register('dni')} />
                            </div>
                            {errors.dni && (
                                <small style={{ marginTop: '10px' }} className="p-invalid text-xs inline-block py-1 px-2 rounded text-red-600">
                                    {errors.dni?.message}
                        ...
                        <div className="p-field p-grid" style={{ margin: '10px' }}>
                            ...
                            <div className="p-col">
                                <InputText id="firstname5" type="text" style={{ marginTop: '10px' }} placeholder="Ingrese su correo" {...register('correo')} autoFocus />
                            </div>
                            {errors.correo && (
                                <small style={{ marginTop: '10px' }} className="p-invalid text-xs inline-block py-1 px-2 rounded text-red-600">
