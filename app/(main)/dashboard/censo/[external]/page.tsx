   ...
   */
    ...
    useEffect(() => {
        ...
        getSitiosNombres(external, get("token")).then((data) => {
            ...
            if (data.props.data.code == '200') {
                ...
                censos_sitio(external, get("token")).then((data) => {
                    ...
                    if (data.props.data.code == '200') {
                        ...
                        setCensos([]); reset(mes); setMeses(mes);
            ...
            } else { setSitio(null); setIrra("0.0"); }
        });
        ...
        <div className="col-12 xl:col-12">
            ...
            <Card title="Registrar Censo por sitio">
                    ...
                    <form onSubmit={handleSubmit(sendInfo)} className="p-fluid p-formgrid p-grid">
                        ...
                        <Divider type="vertical">
                            <div className="p-field p-grid" style={{ margin: "10px" }}>
                                <label className="p-col-fixed" ><b>Provincia: </b>{sitio && sitio.provincia}</label>
                            </div>
                            <div className="p-field p-grid" style={{ margin: "10px" }}>
                                <label className="p-col-fixed" ><b>Canton: </b>{sitio && sitio.canton}</label>
                            </div>
                            <div className="p-field p-grid" style={{ margin: "10px" }}>
                                <label className="p-col-fixed" ><b>Sitio: </b>{sitio && sitio.nombre}</label>
                            </div>
                            <div className="p-field p-grid" style={{ margin: "10px" }}>
                                <label className="p-col-fixed" ><b>Fuente: </b>{sitio && sitio.fuente}</label>
                            </div>
                        </Divider>
                ...
                <Card title="Censo registrado por sitios en meses">
                    <DataTable value={censos} rows={10} paginator
                        dataKey="external"
