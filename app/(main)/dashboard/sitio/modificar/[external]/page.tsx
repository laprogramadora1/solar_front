                ...
                <div className="my-2">
                    <form onSubmit={handleSubmit(sendInfo)} className="p-fluid p-formgrid p-grid">
                        ...
                        <div className="p-field p-grid" style={{ margin: '10px' }}>
                            ...
                            <div className="p-col">
                                <InputText id="firstname3" type="text" style={{ marginTop: '10px' }} placeholder="Ingrese el nombre del canton" {...register('nombre')} defaultValue={obj && obj.nombre} />
                            </div>
                            {errors.nombre && (
                        ...
                        <div className="p-field p-grid" style={{ margin: '10px' }}>
                            ...
                            <div className="p-col">
                                <InputText id="firstname3" type="text" style={{ marginTop: '10px' }} placeholder="Ingrese el valor de la irradiacion" {...register('irradiacion')} defaultValue={obj && obj.irradiacion} />
                            </div>
                            {errors.irradiacion && (
                                <small style={{ marginTop: '10px' }} className="p-invalid text-xs inline-block py-1 px-2 rounded text-red-600">
                        ...
                        <div className="p-field p-grid" style={{ margin: '10px' }}>
                            ...
                            <div className="p-col">
                                <InputText id="firstname3" type="text" style={{ marginTop: '10px' }} placeholder="Ingrese el promedio de irradiacion por anual" {...register('promedio')} defaultValue={obj && obj.promedio} />
                            </div>
                            {errors.promedio && (
                                <small style={{ marginTop: '10px' }} className="p-invalid text-xs inline-block py-1 px-2 rounded text-red-600">
                        ...
                        <div className="p-field p-grid" style={{ margin: '10px' }}>
                            ...
                            <InputText id="firstname3" type="text" style={{ marginTop: '10px' }} defaultValue={position && position.lat} placeholder="Ingrese la latitud" readOnly />
                            <InputText id="firstname31" type="text" style={{ marginTop: '10px' }} defaultValue={position && position.lng} readOnly placeholder="Ingrese la longitud" />
                        </div>
                        ...
                        <div className="p-field p-grid" style={{ margin: '10px' }}>
                            ...
                            <div className="p-col">
                                <InputText id="firstname3" type="text" style={{ marginTop: '10px' }} placeholder="Ingrese la ubicacion" defaultValue={obj && obj.ubicacion} {...register('ubicacion')} />
                            </div>
                            {errors.ubicacion && (
                                <small style={{ marginTop: '10px' }} className="p-invalid text-xs inline-block py-1 px-2 rounded text-red-600">
