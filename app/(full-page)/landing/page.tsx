...
import sol_img from '../../../public/img/sol.jpg';
            ...
            <div id="home" className="landing-wrapper overflow-hidden">
                ...
                <div
                    ...
                    style={{
                        ...
                        backgroundImage: 'url(${sol_img})'
                    }}
                >
                    <div className="mx-4 md:mx-8 mt-0 md:mt-4">
                        <h1 className="text-6xl font-bold text-gray-900 line-height-2">
                            <span className="font-light block">Energia</span>eget magna fermentum
                        </h1>
                        <p className="font-normal text-2xl line-height-3 md:mt-3 text-gray-700">Sed xxxx libero volutpat sed cras. Fames ac turpis egestas integer. Placerat in egestas erat... </p>
